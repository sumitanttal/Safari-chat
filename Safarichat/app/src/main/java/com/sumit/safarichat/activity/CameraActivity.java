    ...
    SurfaceHolder.Callback surfaceCallback = new SurfaceHolder.Callback() {
        public void surfaceCreated(SurfaceHolder holder) {
            try {
                ...
                MessageUtility.showLog("CameraActivity-surfaceCallback",
    ...
    public void scanPhoto(final String imageFileName) {
        msConn = new MediaScannerConnection(CameraActivity.this, new MediaScannerConnection.MediaScannerConnectionClient() {
            public void onMediaScannerConnected() {
                ...
                MessageUtility.showLog("msClient obj  in Photo Utility", "connection established");
            }
            public void onScanCompleted(String path, Uri uri) {
                msConn.disconnect();
                MessageUtility.showLog("msClient obj in Photo Utility", "scan completed");
            }
        });
        msConn.connect();
    }
